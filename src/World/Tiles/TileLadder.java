...
public class TileLadder extends Tile{
    ...
    public TileLadder(int x, int y) {
        super(EnumTile.LADDER_CENTER, x, y);
        bod = PrebuiltBodies.quad(new Point2D((x+(8 * 4)), (y+(6 * 4))), TileConstants.SCALE);
        PhysicsEngine.addChannel("ladder");
    }
